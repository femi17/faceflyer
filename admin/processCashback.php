...
if($id){
mysqli_query($connect, "update cashback set name = '$name', spend = '$spend', description = '$desc', status = 'approved', date = '$date' where id = '$id'");
}else{
mysqli_query($connect, "insert into cashback set store = '$email', name = '$name', spend = '$spend', description = '$desc', status = 'approved', date = '$date', banner = '$banner'");
}
