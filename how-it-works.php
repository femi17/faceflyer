...
<p class="mb-0 text-muted">Sign up to find amazing deals, tasks and which store offers cashback around you
</p>
</div>
</div>
<div class="overflow-hidden border-top d-flex align-items-center p-4">
<a class="d-block" href="home"> Task, Deals, and Cashback. </a>
