...
<title>Osahan Deel - Coupons, Deals & Discounts HTML Template</title>
<!-- Favicon Icon -->
...
<img class="img-fluid w-40" src="images/logo.svg">
</a>
...
<img class="rounded-circle" src="images/user/4.png" alt="">
...
<a class="dropdown-item d-flex align-items-center" href="#">
<div class="dropdown-list-image mr-3">
<img class="rounded-circle" src="images/user/3.png" alt="">
...
<a class="dropdown-item d-flex align-items-center" href="#">
<div class="dropdown-list-image mr-3">
<img class="rounded-circle" src="images/user/2.png" alt="">
...
<a class="dropdown-item d-flex align-items-center" href="#">
<div class="dropdown-list-image mr-3">
<img class="rounded-circle" src="images/user/1.png" alt="">
<div class="status-indicator bg-success"></div>
</div>
<div>
...
<a class="dropdown-item text-center small text-gray-500-500" href="#">Read More Messages</a>
</div>
</li>
...
<img class="img-profile rounded-circle" src="images/user-icon/user.png">
</a>
...
<h5 class="my-0 text-gray-900">All Product Deals</h5>
<div class="dropdown ml-auto">
<a class="btn btn-secondary dropdown-toggle btn-sm border-white-btn" href="#"
role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
Sort by: <span class="text-theme">Popularity</span> &nbsp;&nbsp;
</a>
...
Brands <i class="icofont-thin-down float-right"></i>
</a>
</h6>
</div>
...
<label class="custom-control-label" for="cb1">Samsung </label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb2">
<label class="custom-control-label" for="cb2">Adidas</label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb3">
<label class="custom-control-label" for="cb3">Apple</label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb4">
<label class="custom-control-label" for="cb4">Nokia</label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb3">
<label class="custom-control-label" for="cb3">Apple</label>
...
Categories <i class="icofont-thin-down float-right"></i>
</a>
</h6>
</div>
...
<label class="custom-control-label" for="cb6">Flight </label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb7">
<label class="custom-control-label" for="cb7">Recharge</label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb8">
<label class="custom-control-label" for="cb8">Travel</label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb9">
<label class="custom-control-label" for="cb9">Food</label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb10">
<label class="custom-control-label" for="cb10"> Fashion</label>
</div>
<div class="mt-2"><a href="#" class="link">See all</a></div>
</div>
</div>
...
Stores <i class="icofont-thin-down float-right"></i>
</a>
</h6>
</div>
...
Type of Offer <i class="icofont-thin-down float-right"></i>
</a>
</h6>
</div>
...
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb6">
<label class="custom-control-label" for="cb6">Flight <small
class="text-danger float-right">200 deal</small></label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb7">
<label class="custom-control-label" for="cb7">Recharge <small
class="text-danger float-right">34 deal</small></label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb8">
<label class="custom-control-label" for="cb8">Travel <small
class="text-danger float-right">56 deal</small></label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb9">
<label class="custom-control-label" for="cb9">Food <small
class="text-danger float-right">98 deal</small></label>
</div>
<div class="custom-control custom-checkbox">
<input type="checkbox" class="custom-control-input" id="cb10">
<label class="custom-control-label" for="cb10"> Fashion <small
class="text-danger float-right">21 deal</small></label>
</div>
<div class="mt-2"><a href="#" class="link">See all</a></div>
</div>
</div>
...
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/1.png">
</a>
...
<h6 class="mb-3"><a class="text-gray-900" href="#">Get Flat 30% OFF on Payment
Via RBL Bank</a></h6>
<p class="text-gray-500"><i class="icofont-clock-time"></i> Ends in 18 days</p>
</div>
<div class="custom-card-footer d-flex align-items-center">
<span class="text-danger"><i class="icofont-sale-discount"></i> 50 % OFF</span><a
class="btn btn-sm btn-white ml-auto" href="#">Get Offer</a>
</div>
</div>
</div>
</div>
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/2.png">
</a>
<div class="button-g-btn button-g-btn-up">
...
<div class="p-3 pt-4">
<div class="custom-card-body">
<h6 class="mb-3"><a class="text-gray-900" href="#">Special Offer: Get Up to 50%
Off On Web Hosting
</a>
</h6>
<p class="text-gray-500"><i class="icofont-clock-time"></i> Ends in 18 days</p>
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/3.png">
</a>
<div class="button-g-btn button-g-btn-up">
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/4.png">
</a>
<div class="button-g-btn button-g-btn-up">
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/5.png">
</a>
<div class="button-g-btn button-g-btn-up">
...
<div class="p-3 pt-4">
<div class="custom-card-body">
<h6 class="mb-3"><a class="text-gray-900" href="#">Coupon Code: Get Flat 50% Off
On Online Food</a></h6>
<p class="text-gray-500"><i class="icofont-clock-time"></i> Ends in 18 days</p>
</div>
<div class="custom-card-footer d-flex align-items-center">
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/6.png">
</a>
<div class="button-g-btn button-g-btn-up">
<img class="img-fluid" src="images/brand/6.png">
<span>OYO Rooms</span>
</div>
</div>
<div class="p-3 pt-4">
<div class="custom-card-body">
<h6 class="mb-3"><a class="text-gray-900" href="#">New User - Get Flat Rs.100 OFF
+ Rs.300 Licious Cash
</a>
</h6>
<p class="text-gray-500"><i class="icofont-clock-time"></i> Ends in 18 days</p>
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/7.png">
</a>
<div class="button-g-btn button-g-btn-up">
<img class="img-fluid" src="images/brand/7.png">
<span>Dell</span>
</div>
</div>
<div class="p-3 pt-4">
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/8.png">
</a>
<div class="button-g-btn button-g-btn-up">
<img class="img-fluid" src="images/brand/8.png">
<span>Goodle</span>
</div>
</div>
<div class="p-3 pt-4">
...
<div class="custom-card-image">
<a href="#">
<img class="img-fluid item-img" src="images/custom-card/9.png">
</a>
<div class="button-g-btn button-g-btn-up">
<img class="img-fluid" src="images/brand/9.png">
<span>Askbootstrap</span>
</div>
</div>
<div class="p-3 pt-4">
<div class="custom-card-body">
<h6 class="mb-3"><a class="text-gray-900" href="#">Online Food Offer: Get Up To
50% Off On Online Food</a></h6>
<p class="text-gray-500"><i class="icofont-clock-time"></i> Ends in 18 days</p>
</div>
<div class="custom-card-footer d-flex align-items-center">
<span class="text-danger"><i class="icofont-sale-discount"></i> 50 % OFF</span><a
...
<a href="#" class="btn btn-primary shadow btn-sm show-more-btn">Loading <i
class="fas fa-circle-notch fa-spin"></i></a>
</div>
</div>
</div>
</div>
...
<p class="m-0 text-secondary">Copyright © Your Website 2020</p>
<p class="m-0">
