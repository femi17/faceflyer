...
if($id){
mysqli_query($connect, "update deals set name = '$name', start_date = '$start', end_date = '$end', headline = '$headline', category = '$category', description = '$desc', price = '$price', coin = '$coin', status = 'pending', date = '$date' where id = '$id'");
}else{
mysqli_query($connect, "insert into deals set store = '$email', name = '$name', start_date = '$start', end_date = '$end', headline = '$headline', category = '$category', description = '$desc', price = '$price', coin = '$coin', status = 'pending', date = '$date'");
}
