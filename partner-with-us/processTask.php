...
if($id){
mysqli_query($connect, "update tasks set name = '$name', category = '$category', end_date = '$end', description = '$desc', coin = '$coin', status = 'pending', date = '$date' where id = '$id'");
}else{
mysqli_query($connect, "insert into tasks set store = '$email', name = '$name', category = '$category', end_date = '$end', description = '$desc', coin = '$coin', status = 'pending', date = '$date', banner = '$banner'");
}
