...
grecaptcha.execute('6LcNS7AZAAAAAHeOWW2bDxQCH3nSYF13kaYUa0Sy', {action: 'reset_merchant'}).then(function(token) {
$('#reset-form').prepend('<input type="hidden" name="token" value="' + token + '">');
$('#reset-form').prepend('<input type="hidden" name="action" value="reset_merchant">');
