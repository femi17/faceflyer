...
<title>Sign in - Merchant - Faceflyer</title>
<!-- Favicon Icon -->
...
<h5 class="mt-3 mb-3">Reward every loyalty</h5>
<p>Influnce what and how customer shop from you</p>
<?php if($_GET['error']){ ?>
...
grecaptcha.execute('6LcNS7AZAAAAAHeOWW2bDxQCH3nSYF13kaYUa0Sy', {action: 'signin_merchant'}).then(function(token) {
$('#signin-form').prepend('<input type="hidden" name="token" value="' + token + '">');
$('#signin-form').prepend('<input type="hidden" name="action" value="signin_merchant">');
